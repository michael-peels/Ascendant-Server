...
sub EVENT_ITEM {
  if ($faction == 1) { #req ally CoV 
    if (plugin::check_handin(\%itemcount, 25841 => 3, 24961 => 1)) { #cap
      plugin::velious_armor_tier_reward(31140); # Item: Akkirus' Crown of the Risen
    }
    elsif (plugin::check_handin(\%itemcount, 25805 => 3, 24956 => 1)) { #bp
      plugin::velious_armor_tier_reward(31141); # Item: Akkirus' Chestplate of the Risen
    }
    elsif (plugin::check_handin(\%itemcount, 25815 => 3, 24958 => 1)) { #arm
      plugin::velious_armor_tier_reward(31142); # Item: Akkirus' Vambraces of the Risen
    }
    elsif (plugin::check_handin(\%itemcount, 25836 => 3, 24960 => 1)) { #bracer
      plugin::velious_armor_tier_reward(31143); # Item: Akkirus' Bracelet of the Risen
    }
    elsif (plugin::check_handin(\%itemcount, 25840 => 3, 24962 => 1)) { #glove
      plugin::velious_armor_tier_reward(31144); # Item: Akkirus' Gauntlets of the Risen
    }
    elsif (plugin::check_handin(\%itemcount, 25827 => 3, 24957 => 1)) { #leg
      plugin::velious_armor_tier_reward(31145); # Item: Akkirus' Greaves of the Risen
    }
    elsif (plugin::check_handin(\%itemcount, 25838 => 3, 24959 => 1)) { #boots
      plugin::velious_armor_tier_reward(31146); # Item: Akkirus' Boots of the Risen
    }
    else {
