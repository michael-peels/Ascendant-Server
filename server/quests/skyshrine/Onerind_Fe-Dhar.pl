...
sub EVENT_ITEM {
  if ($faction == 1) { #req ally CoV 
    if (plugin::check_handin(\%itemcount, 25831 => 3, 24961 => 1)) { #cap
      plugin::velious_armor_tier_reward(31098); # Item: Blood Lord's Crown
    }
    elsif (plugin::check_handin(\%itemcount, 25814 => 3, 24956 => 1)) { #bp
      plugin::velious_armor_tier_reward(31099); # Item: Blood Lord's Breastplate
    }
    elsif (plugin::check_handin(\%itemcount, 25821 => 3, 24958 => 1)) { #arm
      plugin::velious_armor_tier_reward(31100); # Item: Blood Lord's Vambraces
    }
    elsif (plugin::check_handin(\%itemcount, 25838 => 3, 24960 => 1)) { #bracer
      plugin::velious_armor_tier_reward(31101); # Item: Blood Lord's Bracer
    }
    elsif (plugin::check_handin(\%itemcount, 25832 => 3, 24962 => 1)) { #glove
      plugin::velious_armor_tier_reward(31102); # Item: Blood Lord's Gauntlets
    }
    elsif (plugin::check_handin(\%itemcount, 25825 => 3, 24957 => 1)) { #leg
      plugin::velious_armor_tier_reward(31103); # Item: Blood Lord's Greaves
    }
    elsif (plugin::check_handin(\%itemcount, 25833 => 3, 24959 => 1)) { #boots
      plugin::velious_armor_tier_reward(31104); # Item: Blood Lord's Boots
    }
    else {
