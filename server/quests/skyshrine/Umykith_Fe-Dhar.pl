...
sub EVENT_ITEM {
  if ($faction < 2) { #req ally CoV 
    if (plugin::check_handin(\%itemcount, 25831 => 3, 24961 => 1)) { #cap
      plugin::velious_armor_tier_reward(31133); # Item: Helm of Twilight
    }
    elsif (plugin::check_handin(\%itemcount, 25814 => 3, 24956 => 1)) { #bp
      plugin::velious_armor_tier_reward(31134); # Item: Breastplate of Twilight
    }
    elsif (plugin::check_handin(\%itemcount, 25821 => 3, 24958 => 1)) { #arm
      plugin::velious_armor_tier_reward(31135); # Item: Vambraces of Twilight
    }
    elsif (plugin::check_handin(\%itemcount, 25838 => 3, 24960 => 1)) { #wrist
      plugin::velious_armor_tier_reward(31136); # Item: Bracer of Twilight
    }
    elsif (plugin::check_handin(\%itemcount, 25832 => 3, 24962 => 1)) { #hand
      plugin::velious_armor_tier_reward(31137); # Item: Gauntlets of Twilight
    }
    elsif (plugin::check_handin(\%itemcount, 25825 => 3, 24957 => 1)) { #leg
      plugin::velious_armor_tier_reward(31138); # Item: Greaves of Twilight
    }
    elsif (plugin::check_handin(\%itemcount, 25833 => 3, 24959 => 1)) { #boots
      plugin::velious_armor_tier_reward(31139); # Item: Boots of Twilight
    }
    else {
