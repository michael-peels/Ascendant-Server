...
sub EVENT_ITEM {
  if ($faction == 1) { #req ally CoV 
    if (plugin::check_handin(\%itemcount, 25831 => 3, 24961 => 1)) { #cap
      plugin::velious_armor_tier_reward(31182); # Item: Crown of the Myrmidon
    }
    elsif (plugin::check_handin(\%itemcount, 25814 => 3, 24956 => 1)) { #bp
      plugin::velious_armor_tier_reward(31183); # Item: Breastplate of the Myrmidon
    }
    elsif (plugin::check_handin(\%itemcount, 25821 => 3, 24958 => 1)) { #arm
      plugin::velious_armor_tier_reward(31184); # Item: Vambraces of the Myrmidon
    }
    elsif (plugin::check_handin(\%itemcount, 25838 => 3, 24960 => 1)) { #bracer
      plugin::velious_armor_tier_reward(31185); # Item: Bracer of the Myrmidon
    }
    elsif (plugin::check_handin(\%itemcount, 25832 => 3, 24962 => 1)) { #glove
      plugin::velious_armor_tier_reward(31186); # Item: Gauntlets of the Myrmidon
    }
    elsif (plugin::check_handin(\%itemcount, 25825 => 3, 24957 => 1)) { #leg
      plugin::velious_armor_tier_reward(31187); # Item: Greaves of the Myrmidon
    }
    elsif (plugin::check_handin(\%itemcount, 25833 => 3, 24959 => 1)) { #boots
      plugin::velious_armor_tier_reward(31188); # Item: Boots of the Myrmidon
    }
    else {
