...
sub EVENT_ITEM {
  if ($faction == 1) { #req ally CoV 
    if (plugin::check_handin(\%itemcount, 25837 => 3, 24982 => 1)) { #cap
      plugin::velious_armor_tier_reward(31168); # Item: Prestidigitator's Headband
    }
    elsif (plugin::check_handin(\%itemcount, 25807 => 3, 24977 => 1)) { #bp
      plugin::velious_armor_tier_reward(31169); # Item: Prestidigitator's Robe
    }
    elsif (plugin::check_handin(\%itemcount, 25818 => 3, 24979 => 1)) { #arm
      plugin::velious_armor_tier_reward(31170); # Item: Prestidigitator's Sleeves
    }
    elsif (plugin::check_handin(\%itemcount, 25841 => 3, 24981 => 1)) { #bracer
      plugin::velious_armor_tier_reward(31171); # Item: Prestidigitator's Wristband
    }
    elsif (plugin::check_handin(\%itemcount, 25832 => 3, 24983 => 1)) { #glove
      plugin::velious_armor_tier_reward(31172); # Item: Prestidigitator's Gloves
    }
    elsif (plugin::check_handin(\%itemcount, 25816 => 3, 24978 => 1)) { #leg
      plugin::velious_armor_tier_reward(31173); # Item: Prestidigitator's Trousers
    }
    elsif (plugin::check_handin(\%itemcount, 25829 => 3, 24980 => 1)) { #boots
      plugin::velious_armor_tier_reward(31174); # Item: Prestidigitator's Boots
    }
    else {
