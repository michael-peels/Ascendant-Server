...
sub EVENT_ITEM {
  if ($faction == 1) { #req ally CoV 
    if (plugin::check_handin(\%itemcount, 25831 => 3, 24968 => 1)) { #cap
      plugin::velious_armor_tier_reward(31112); # Item: Golden Leaf Helm
    }
    elsif (plugin::check_handin(\%itemcount, 25814 => 3, 24963 => 1)) { #bp
      plugin::velious_armor_tier_reward(31113); # Item: Golden Leaf Breastplate
    }
    elsif (plugin::check_handin(\%itemcount, 25821 => 3, 24965 => 1)) { #arm
      plugin::velious_armor_tier_reward(31114); # Item: Golden Leaf Vambraces
    }
    elsif (plugin::check_handin(\%itemcount, 25838 => 3, 24967 => 1)) { #bracer
      plugin::velious_armor_tier_reward(31115); # Item: Golden Leaf Bracer
    }
    elsif (plugin::check_handin(\%itemcount, 25832 => 3, 24969 => 1)) { #glove
      plugin::velious_armor_tier_reward(31116); # Item: Golden Leaf Gauntlets
    }
    elsif (plugin::check_handin(\%itemcount, 25825 => 3, 24964 => 1)) { #leg
      plugin::velious_armor_tier_reward(31117); # Item: Golden Leaf Greaves
    }
    elsif (plugin::check_handin(\%itemcount, 25833 => 3, 24966 => 1)) { #boots
      plugin::velious_armor_tier_reward(31118); # Item: Golden Leaf Boots
    }
    else {
