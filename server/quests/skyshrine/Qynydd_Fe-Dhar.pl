...
sub EVENT_ITEM {
  if ($faction == 1) { #req ally CoV 
    if (plugin::check_handin(\%itemcount, 25841 => 3, 24975 => 1)) { #cap
      plugin::velious_armor_tier_reward(31147); # Item: Woven Grass Headband
    }
    elsif (plugin::check_handin(\%itemcount, 25805 => 3, 24970 => 1)) { #bp
      plugin::velious_armor_tier_reward(31148); # Item: Woven Grass Chestguard
    }
    elsif (plugin::check_handin(\%itemcount, 25815 => 3, 24972 => 1)) { #arm
      plugin::velious_armor_tier_reward(31149); # Item: Woven Grass Vambraces
    }
    elsif (plugin::check_handin(\%itemcount, 25836 => 3, 24974 => 1)) { #bracer
      plugin::velious_armor_tier_reward(31150); # Item: Woven Grass Bracelet
    }
    elsif (plugin::check_handin(\%itemcount, 25840 => 3, 24976 => 1)) { #glove
      plugin::velious_armor_tier_reward(31151); # Item: Woven Grass Gauntlets
    }
    elsif (plugin::check_handin(\%itemcount, 25827 => 3, 24971 => 1)) { #leg
      plugin::velious_armor_tier_reward(31152); # Item: Woven Grass Greaves
    }
    elsif (plugin::check_handin(\%itemcount, 25838 => 3, 24973 => 1)) { #boots
      plugin::velious_armor_tier_reward(31153); # Item: Woven Grass Boots
    }
    else {
