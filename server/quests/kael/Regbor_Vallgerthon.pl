...
sub EVENT_ITEM { 
  if ($faction == 1) { #requires ally Kromzek faction 
    if (plugin::check_handin(\%itemcount, 25831 => 3, 24912 => 1)) { # cap 
      plugin::velious_armor_tier_reward(55310); # Item: Firebrand's Coif 
      quest::exp(150000); 
      ...
      plugin::velious_armor_tier_reward(55311); # Item: Firebrand's Tunic
      quest::exp(150000); 
      quest::faction(429,20); # King Tormax 
      quest::faction(448,20); # Kromzek 
      quest::faction(430,-20); # Claws of Veeshan 
      ...
      plugin::velious_armor_tier_reward(55312); # Item: Firebrand's Sleeves
      quest::exp(150000); 
      quest::faction(429,20); # King Tormax 
      quest::faction(448,20); # Kromzek 
      quest::faction(430,-20); # Claws of Veeshan 
      ...
      plugin::velious_armor_tier_reward(55313); # Item: Firebrand's Bracer
      quest::exp(150000); 
      quest::faction(429,20); # King Tormax 
      quest::faction(448,20); # Kromzek 
      quest::faction(430,-20); # Claws of Veeshan 
      ...
      plugin::velious_armor_tier_reward(55314); # Item: Firebrand's Gauntlets
      quest::exp(150000); 
      quest::faction(429,20); # King Tormax 
      quest::faction(448,20); # Kromzek 
      quest::faction(430,-20); # Claws of Veeshan 
      ...
      plugin::velious_armor_tier_reward(55315); # Item: Firebrand's Leggings
      quest::exp(150000); 
      quest::faction(429,20); # King Tormax 
      quest::faction(448,20); # Kromzek 
      quest::faction(430,-20); # Claws of Veeshan 
      ...
      plugin::velious_armor_tier_reward(55316); # Item: Firebrand's Boots
      quest::exp(150000); 
      quest::faction(429,20); # King Tormax 
      quest::faction(448,20); # Kromzek 
      quest::faction(430,-20); # Claws of Veeshan 
