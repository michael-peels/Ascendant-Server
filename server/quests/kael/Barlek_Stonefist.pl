...
sub EVENT_ITEM {
  if ($faction == 1) { #requires ally Kromzek faction
    if (plugin::check_handin(\%itemcount, 25831 => 3, 24905 => 1)) { # cap
      plugin::velious_armor_tier_reward(25370); # Item: Shining Helm
      quest::exp(150000);
      ...
      plugin::velious_armor_tier_reward(25371); # Item: Shining Breastplate
      quest::exp(150000);
      quest::faction(429,20); # King Tormax
      quest::faction(448,20); # Kromzek
      quest::faction(430,-20); # Claws of Veeshan
      ...
      plugin::velious_armor_tier_reward(25372); # Item: Shining Vambraces
      quest::exp(150000);
      quest::faction(429,20); # King Tormax
      quest::faction(448,20); # Kromzek
      quest::faction(430,-20); # Claws of Veeshan
      ...
      plugin::velious_armor_tier_reward(25373); # Item: Shining Bracer
      quest::exp(150000);
      quest::faction(429,20); # King Tormax
      quest::faction(448,20); # Kromzek
      quest::faction(430,-20); # Claws of Veeshan
      ...
      plugin::velious_armor_tier_reward(25374); # Item: Shining Gauntlets
      quest::exp(150000);
      quest::faction(429,20); # King Tormax
      quest::faction(448,20); # Kromzek
      quest::faction(430,-20); # Claws of Veeshan
      ...
      plugin::velious_armor_tier_reward(25375); # Item: Shining Greaves
      quest::exp(150000);
      quest::faction(429,20); # King Tormax
      quest::faction(448,20); # Kromzek
      quest::faction(430,-20); # Claws of Veeshan
      ...
      plugin::velious_armor_tier_reward(25376); # Item: Shining Boots
      quest::exp(150000);
      quest::faction(429,20); # King Tormax
      quest::faction(448,20); # Kromzek
      quest::faction(430,-20); # Claws of Veeshan
