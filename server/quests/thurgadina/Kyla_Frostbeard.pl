...
sub EVENT_ITEM {
  if ($faction <= 3) { # Require warmly and greater faction
    if (plugin::check_handin(\%itemcount, 25837 => 3, 24954 => 1)) { # cap
      plugin::velious_armor_tier_reward(31070); # Item: Arch Mage's Crown
      quest::exp(100000);
      ...
      plugin::velious_armor_tier_reward(31071); # Item: Arch Mage's Robe
      quest::exp(100000);
      quest::faction(406,20); # coldain
      quest::faction(405,20); # Dain Frostreaver IV
      quest::faction(419,-60); # Kromrif
      ...
      plugin::velious_armor_tier_reward(31072); # Item: Arch Mage's Sleeves
      quest::exp(100000);
      quest::faction(406,20); # coldain
      quest::faction(405,20); # Dain Frostreaver IV
      quest::faction(419,-60); # Kromrif
      ...
      plugin::velious_armor_tier_reward(31073); # Item: Arch Mage's Warband
      quest::exp(100000);
      quest::faction(406,20); # coldain
      quest::faction(405,20); # Dain Frostreaver IV
      quest::faction(419,-60); # Kromrif
      ...
      plugin::velious_armor_tier_reward(31074); # Item: Arch Mage's Gloves
      quest::exp(100000);
      quest::faction(406,20); # coldain
      quest::faction(405,20); # Dain Frostreaver IV
      quest::faction(419,-60); # Kromrif
      ...
      plugin::velious_armor_tier_reward(31075); # Item: Arch Mage's Pantaloons
      quest::exp(100000);
      quest::faction(406,20); # coldain
      quest::faction(405,20); # Dain Frostreaver IV
      quest::faction(419,-60); # Kromrif
      ...
      plugin::velious_armor_tier_reward(31076); # Item: Arch Mage's Boots
      quest::exp(100000);
      quest::faction(406,20); # coldain
      quest::faction(405,20); # Dain Frostreaver IV
      quest::faction(419,-60); # Kromrif
